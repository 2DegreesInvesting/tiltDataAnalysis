...
```{r}
print(paste("Distinct products of emission profile:", n_distinct(emission_product_example$ep_product)))
print(paste("Distinct products of sector profile:", n_distinct(sector_product_example$ep_product)))
```
...
print(paste("Matched distinct products of emission profile:", matched_distinct_products(emission_product_example, "emission_profile")))
print(paste("Matched distinct products of sector profile:", matched_distinct_products(sector_product_example, "sector_profile")))
```
...
print(paste("Average amount of distinct products per company for emission profile:", avg_distinct_products_per_company(emission_product_example)))
print(paste("Average amount of distinct products per company for sector profile:", avg_distinct_products_per_company(sector_product_example)))
```
...
print(paste("Distinct products without a risk category for emission profile:", distinct_products_without_risk_category(emission_product_example, "emission_profile")))
print(paste("Distinct products without a risk category for sector profile:", distinct_products_without_risk_category(sector_product_example, "sector_profile")))
```
...
print(paste("Average profile ranking of all products:", avg_profile_ranking_all_products))
```
...
print(paste("Average reduction targets of all products:", avg_reduction_targets_all_products))
```
...
print(paste("Average transition risk scores of all products:", avg_transition_risk_score_all_products))
```
...
companies_atleast_one_matched_product <- product_emission |>
  select(all_of(c("companies_id", "emission_profile"))) |>
  distinct() |>
  filter(!is.na(emission_profile))
companies_atleast_one_matched_product
```
...
print(paste("Average NA share per company with atleast one matched product for emission profile:", average_result))
```
