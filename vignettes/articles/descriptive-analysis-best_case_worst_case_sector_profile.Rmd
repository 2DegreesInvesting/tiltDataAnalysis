...
sector_target_avg_equal_weight_per_benchmark_france <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_equal_weight", "france")
sector_target_avg_equal_weight_per_benchmark_austria <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_equal_weight", "austria")
sector_target_avg_equal_weight_per_benchmark_germany <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_equal_weight", "germany")
sector_target_avg_equal_weight_per_benchmark_netherlands <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_equal_weight", "netherlands")
sector_target_avg_equal_weight_per_benchmark_spain <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_equal_weight", "spain")
```
...
```{r, warning=FALSE, echo=FALSE}
sector_target_avg_best_case_per_benchmark_france <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_best_case", "france")
sector_target_avg_best_case_per_benchmark_austria <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_best_case", "austria")
sector_target_avg_best_case_per_benchmark_germany <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_best_case", "germany")
sector_target_avg_best_case_per_benchmark_netherlands <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_best_case", "netherlands")
sector_target_avg_best_case_per_benchmark_spain <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_best_case", "spain")
```
...
```{r, warning=FALSE, echo=FALSE}
sector_target_avg_worst_case_per_benchmark_france <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_worst_case", "france")
sector_target_avg_worst_case_per_benchmark_austria <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_worst_case", "austria")
sector_target_avg_worst_case_per_benchmark_germany <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_worst_case", "germany")
sector_target_avg_worst_case_per_benchmark_netherlands <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_worst_case", "netherlands")
sector_target_avg_worst_case_per_benchmark_spain <- sector_target_avg_per_benchmark_country(transition_risk_product_example, "sector_target_avg_worst_case", "spain")
```
