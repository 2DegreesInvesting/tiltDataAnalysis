...
avg_per_benchmark_risk_category <- function(data, col) {
  data |>
    select(all_of(c("scenario", "year", "sector_category", col))) |>
    distinct() |>
    mutate(grouping_sector = paste(.data$scenario, .data$year, sep = "_")) |>
    select(-c("scenario", "year")) |>
    summarise(total_mode = sum(.data[[col]], na.rm = TRUE), .by = c("grouping_sector", "sector_category")) |>
...
avg_sector_profile_equal_weight_per_benchmark_risk_category <- avg_per_benchmark_risk_category(sector_product_example, "sector_profile_equal_weight") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
```
...
plot_bar_plot_profile <- function(data, col) {
  ggplot(data, aes(x = .data[[col]], y = .data$grouping_sector, fill = .data$sector_category)) +
...
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under equal weight assumption", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category", fill = " sector category")
```

### Average `sector_profile_best_case` per grouping_sector and sector_category

```{r, warning=FALSE, echo=FALSE}
avg_sector_profile_best_case_per_benchmark_risk_category <- avg_per_benchmark_risk_category(sector_product_example, "sector_profile_best_case") |>
  rename("Average `sector_profile_best_case`" = "proportion")
```

#### Bar plot

```{r, echo = FALSE, warning=FALSE}
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_risk_category, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under best case assumption", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category", fill = " sector category")
```

### Average `sector_profile_worst_case` per grouping_sector and sector_category

```{r, warning=FALSE, echo=FALSE}
avg_sector_profile_worst_case_per_benchmark_risk_category <- avg_per_benchmark_risk_category(sector_product_example, "sector_profile_worst_case") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
```

#### Bar plot

```{r, echo = FALSE, warning=FALSE}
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_risk_category, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under worst case assumption", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category", fill = " sector category")
```

### Average `sector_profile_equal_weight` per grouping_sector and sector_category for a country

```{r, warning=FALSE, echo=FALSE}
avg_per_benchmark_country_risk_category <- function(data, col, country_value) {
  data |>
    select(all_of(c("scenario", "year", "country", "sector_category", col))) |>
    distinct() |>
    mutate(grouping_sector = paste(.data$scenario, .data$year, sep = "_")) |>
    select(-c("scenario", "year")) |>
...
avg_sector_profile_equal_weight_per_benchmark_risk_category_france <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_equal_weight", "france") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
avg_sector_profile_equal_weight_per_benchmark_risk_category_austria <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_equal_weight", "austria") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
avg_sector_profile_equal_weight_per_benchmark_risk_category_germany <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_equal_weight", "germany") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
avg_sector_profile_equal_weight_per_benchmark_risk_category_netherlands <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_equal_weight", "netherlands") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
avg_sector_profile_equal_weight_per_benchmark_risk_category_spain <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_equal_weight", "spain") |>
  rename("Average `sector_profile_equal_weight`" = "proportion")
```
...
```{r, echo = FALSE, warning=FALSE}
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category_france, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under \n equal weight assumption for France", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category for `france`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category_austria, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under \n equal weight assumption for Austria", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category for `austria`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category_germany, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under \n equal weight assumption for Germany", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category for `germany`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category_netherlands, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under \n equal weight assumption for Netherlands", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category for `netherlands`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_equal_weight_per_benchmark_risk_category_spain, "Average `sector_profile_equal_weight`") +
  labs(x = "Average sector category under \n equal weight assumption for Spain", y = "Group", title = "Average sector category under equal weight \n assumption per grouping_sector and \n sector_category for country `spain`", fill = " sector category")
```

### Average `sector_profile_base_case` per grouping_sector and sector_category for a country

```{r, warning=FALSE, echo = FALSE}
avg_sector_profile_best_case_per_benchmark_country_risk_france <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_best_case", "france") |>
  rename("Average `sector_profile_best_case`" = "proportion")
avg_sector_profile_best_case_per_benchmark_country_risk_austria <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_best_case", "austria") |>
  rename("Average `sector_profile_best_case`" = "proportion")
avg_sector_profile_best_case_per_benchmark_country_risk_germany <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_best_case", "germany") |>
  rename("Average `sector_profile_best_case`" = "proportion")
avg_sector_profile_best_case_per_benchmark_country_risk_netherlands <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_best_case", "netherlands") |>
  rename("Average `sector_profile_best_case`" = "proportion")
avg_sector_profile_best_case_per_benchmark_country_risk_spain <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_best_case", "spain") |>
  rename("Average `sector_profile_best_case`" = "proportion")
```
...
```{r, echo = FALSE, warning=FALSE}
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_country_risk_france, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under \n best case assumption for France", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category for `france`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_country_risk_austria, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under \n best case assumption for Austria", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category for `austria`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_country_risk_germany, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under \n best case assumption for Germany", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category for `germany`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_country_risk_netherlands, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under \n best case assumption for Netherlands", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category for `netherlands`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_best_case_per_benchmark_country_risk_spain, "Average `sector_profile_best_case`") +
  labs(x = "Average sector category under \n best case assumption for Spain", y = "Group", title = "Average sector category under best case \n assumption per grouping_sector and \n sector_category for `spain`", fill = " sector category")
```

### Average `sector_profile_worst_case` per grouping_sector and sector_category for a country

```{r, warning=FALSE, echo = FALSE}
avg_sector_profile_worst_case_per_benchmark_country_risk_france <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_worst_case", "france") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
avg_sector_profile_worst_case_per_benchmark_country_risk_austria <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_worst_case", "austria") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
avg_sector_profile_worst_case_per_benchmark_country_risk_germany <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_worst_case", "germany") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
avg_sector_profile_worst_case_per_benchmark_country_risk_netherlands <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_worst_case", "netherlands") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
avg_sector_profile_worst_case_per_benchmark_country_risk_spain <- avg_per_benchmark_country_risk_category(sector_product_example, "sector_profile_worst_case", "spain") |>
  rename("Average `sector_profile_worst_case`" = "proportion")
```
...
```{r, echo = FALSE, warning=FALSE}
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_country_risk_france, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under \n worst case assumption for France", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category for `france`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_country_risk_austria, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under \n worst case assumption for Austria", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category for `austria`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_country_risk_germany, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under \n worst case assumption for Germany", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category for `germany`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_country_risk_netherlands, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under \n worst case assumption for Netherlands", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category for `netherlands`", fill = " sector category")
plot_bar_plot_profile(avg_sector_profile_worst_case_per_benchmark_country_risk_spain, "Average `sector_profile_worst_case`") +
  labs(x = "Average sector category under \n worst case assumption for Spain", y = "Group", title = "Average sector category under worst case \n assumption per grouping_sector and \n sector_category for `spain`", fill = " sector category")
```
